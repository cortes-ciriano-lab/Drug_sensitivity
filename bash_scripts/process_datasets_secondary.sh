...
bsub -P gpu -gpu - -M 30G -e e_sec_${values_from}.log -o o_sec_${values_from}.log -J pri_sec "python /hps/research1/icortes/acunha/python_scripts/Drug_sensitivity/py_scripts/process_datasets_secondary.py pancancer $values_from"