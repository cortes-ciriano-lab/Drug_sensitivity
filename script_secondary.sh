...
run_type="start"
type_data="secondary"
for model in "NNet" "lGBM" ; do #"RF" "NNet" "lGBM"
	if [ "${model}" == "NNet" ] ;  then
		perc_train="0.7"
		perc_val="0.15"
									...
									for prism_from in "ic50" ; do #"ic50" "auc"
										...
										for type_split in "random" "leave-one-cell-line-out" "leave-one-tumour-out" ; do 
											...
											for to_test in `cat ${file_lines}` ; do
												...
												#echo "/hps/research1/icortes/acunha/python_scripts/Drug_sensitivity/new_results/${type_data}/${data_from}/${model}_${network_info}_${lr}_${size_batch}_${n_epoch}_${perc_train}_${perc_val}_${dropout}_${gam}_${step}_${seed}_${epoch_reset}_${type_split}_${to_test}"
