...
class OneHotFeaturizer():
    ...
    # def load_charset(self, file):
    #     charset = pickle.load(open(file, 'rb'))
    #     self.charset = charset
        
    def check_smile(self, smile):
        res = set(smile) - set(self.charset)
        if res:
            return False #there are unusual letters
        else:
            return True