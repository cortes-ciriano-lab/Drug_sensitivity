...
class Drug_sensitivity_single_cell:
    ...
    def __train_lgbm_or_linear(self, model, sc_bottlenecks, drug_bottlenecks, train_set_index):
        X_train = []
        y_real = []
    ...
    def train_model(self, model, sc_bottlenecks, drug_bottlenecks, train_set_index, validation_set_index = []):
        ...
        if self.model_architecture == 'NNet':
            ...
            model = self.__train_lgbm_or_linear(model, sc_bottlenecks, drug_bottlenecks, train_set_index)
    ...
    def __run_test_set_lgbm_or_linear(self, model, sc_bottlenecks, drug_bottlenecks, test_set_index):
        y_real = []
        y_pred = []
    ...
    def run_test_set(self, model, sc_bottlenecks, drug_bottlenecks, test_set_index):
        if self.model_architecture == 'NNet':
            ...
            self.__run_test_set_lgbm_or_linear(model, sc_bottlenecks, drug_bottlenecks, test_set_index)
